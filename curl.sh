...
echo "-------3-------"
echo "3 测试put类型的Customer新增接口，获取返回的customer_id"
...
echo "-------5-------"
echo "5 测试delete类型的Customer删除接口"
curl -v -X DELETE -d "id=$Id" "http://192.168.99.100:8082/customer/delete"
